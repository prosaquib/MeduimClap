...
/**
 * useClapAnimation Custom Hook for animation
 */
...
/**
 * Controlled Component and Reusable Style Example
 */
const MediumClap = ({ children, onClap, values = null, style: userStyles = {}, className, }) => {
...
const ClapCount = ({ style: userStyles = {}, className }) => {
    ...
    return <span ref={setRef} data-refkey='clapCountRef' className={classNames} style={userStyles}>
        +{count}
    </span>
}
...
const CountTotal = ({ style: userStyles = {}, className }) => {
    ...
    return <span ref={setRef} data-refkey='clapTotalRef' className={classNames} style={userStyles}>
        {countTotal}
    </span>
}
